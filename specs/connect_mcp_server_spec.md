# Connect MCP Server Specification
...
1. The verifier calls `GET /connect_mcp/v1/identity` with that bearer.
...
All variables use the `CONNECT_MCP_` prefix. Required: `ODOO_URL`. Optional:
