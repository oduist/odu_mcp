...
class ConnectMcpService(models.AbstractModel):
    _name = "connect.mcp.service"
    ...
    def execute_request(
        ...
        *,
        ...
        error_class = False
        outcome = "success"
        approval = self.env["connect.mcp.approval"]
    ...
    def _op_change_preview(self, access, params):
        ...
        payload_json = self.env["connect.mcp.approval"]._canonical_payload(normalized)
        payload_hash = self.env["connect.mcp.approval"]._payload_digest(payload_json)
        Approval = self.env["connect.mcp.approval"].sudo()
    ...
    def _audit(
        ...
        *,
        ...
        self.env["connect.mcp.audit.log"].sudo().with_context(
